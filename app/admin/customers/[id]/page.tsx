...
export default function AdminCustomerDetail() {
  ...
  return (
    <div className="cd-container">
      {/* Back */}
      <button onClick={() => router.back()} style={{ background: 'none', border: 'none', color: '#f97316', fontWeight: 600, cursor: 'pointer', fontSize: '0.88rem', marginBottom: 18, padding: '8px 0', display: 'flex', alignItems: 'center', gap: 6 }}>
        ← Back to Customers
      </button>
