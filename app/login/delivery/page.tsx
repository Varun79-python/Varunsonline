    ...
    <div style={{ minHeight: '100vh', background: '#f8fafc', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, padding: '0 24px 40px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <h1 style={{ fontSize: '1.5rem', fontWeight: 800, color: '#0f172a', marginBottom: 4 }}>Delivery Partner</h1>
          <p style={{ color: '#64748b', fontSize: '0.9rem' }}>Sign in to start delivering</p>
        </div>
        ...
        <div style={{ textAlign: 'center', marginTop: 20 }}>
          ...
          <button onClick={() => router.push('/delivery/register')} style={{ background: 'none', border: 'none', color: '#22c55e', fontWeight: 700, fontSize: '0.9rem', cursor: 'pointer' }}>Register</button>
        </div>
      </div>
